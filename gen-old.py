# Original code from: Sudoku Generator Algorithm - www.101computing.net/sudoku-generator-algorithm/
# import turtle
import tkinter
...
# Migrate from the original graphics library "Turtle" to Tkinter
myPen = turtle.Turtle()
# myPen.tracer(0)
myPen.speed(0)
myPen.color("#000000")
